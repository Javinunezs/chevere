...
import LikesPosts from "../Posts/LikesPosts";
...
export function Posts(){
    ...
    return(
        <div className="relative flex items-center grid grid-cols-3  bg-gray-200">
            ...
            {posts.length === 0 ? (
                   ...
                   posts.map(({id,title,description,imageUrl, createdAt,createdBy,userId,likes,comments,assists,savePost, sport}) => (
